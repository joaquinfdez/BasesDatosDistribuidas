...
BEGIN
PR_INS_SUMINISTRO(1, 1, 4, '12-06-2016', 100);
PR_INS_SUMINISTRO(1, 2, 5, '11-07-2016', 150);
PR_INS_SUMINISTRO(1, 3, 14, '15-07-2016', 200);
PR_INS_SUMINISTRO(2, 2, 2, '03-04-2016', 20);
PR_INS_SUMINISTRO(2, 1, 7,'04-05-2016', 50);
PR_INS_SUMINISTRO(2, 2, 6, '15-09-2016', 40);
PR_INS_SUMINISTRO(2, 3, 16, '20-09-2016', 100);
PR_INS_SUMINISTRO(3, 10, 3, '21-02-2016', 100);
PR_INS_SUMINISTRO(3, 10, 6, '02-08-2016', 90);
PR_INS_SUMINISTRO(3, 11, 13, '03-10-2016', 200);
PR_INS_SUMINISTRO(3, 12, 20, '04-11-2016', 150);
PR_INS_SUMINISTRO(4, 12, 8, '01-03-2016', 50);
PR_INS_SUMINISTRO(4, 12, 17, '03-05-2016', 70);
PR_INS_SUMINISTRO(5, 7, 16, '14-08-2016', 50);
PR_INS_SUMINISTRO(5, 9, 18, '01-10-2016', 100);
PR_INS_SUMINISTRO(6, 8, 15, '13-01-2016', 100);
PR_INS_SUMINISTRO(6, 8, 9, '19-02-2016', 150);
PR_INS_SUMINISTRO(6, 9, 19, '27-06-2016', 160);
PR_INS_SUMINISTRO(6, 7, 21, '17-09-2016', 200);
PR_INS_SUMINISTRO(7, 4, 1, '15-02-2016', 80);
PR_INS_SUMINISTRO(7, 5, 7, '17-05-2016', 50);
PR_INS_SUMINISTRO(7, 4, 10, '21-06-2016', 70);
PR_INS_SUMINISTRO(8, 6, 14, '11-01-2016', 50);
PR_INS_SUMINISTRO(8, 6, 4, '14-03-2016', 60);
PR_INS_SUMINISTRO(8, 4, 6, '21-05-2016', 70);
END;
/
COMMIT;
...
BEGIN
PR_INS_PEDIDOSUC(1, 4, 4, '12-06-2016', 100);
PR_INS_PEDIDOSUC(1, 10, 7, '05-05-2016', 50);
PR_INS_PEDIDOSUC(2, 7, 5, '12-07-2016', 150);
PR_INS_PEDIDOSUC(2, 5, 2, '04-04-2016', 20);
PR_INS_PEDIDOSUC(2, 8, 6, '16-09-2016', 40);
PR_INS_PEDIDOSUC(3, 6, 14, '15-07-2016', 200);
PR_INS_PEDIDOSUC(3, 9, 16, '21-09-2016', 100);
PR_INS_PEDIDOSUC(4, 1, 10, '22-06-2016', 70);
PR_INS_PEDIDOSUC(4, 7, 6, '22-05-2016', 70);
PR_INS_PEDIDOSUC(5, 10, 7, '18-05-2016', 50);
PR_INS_PEDIDOSUC(7, 2, 21, '18-09-2016', 200);
PR_INS_PEDIDOSUC(8, 11, 15, '14-01-2016', 100);
PR_INS_PEDIDOSUC(8, 2, 9, '20-02-2016', 150);
PR_INS_PEDIDOSUC(9, 3, 18, '02-10-2016', 100);
PR_INS_PEDIDOSUC(9, 12, 19, '28-06-2016', 160);
PR_INS_PEDIDOSUC(10, 4, 3, '22-02-2016', 100) ;
PR_INS_PEDIDOSUC(10, 8, 6, '02-08-2016', 90);
PR_INS_PEDIDOSUC(11, 9, 13, '04-10-2016', 200);
PR_INS_PEDIDOSUC(12, 4, 17, '04-05-2016', 70);
END;
/
COMMIT;
/
